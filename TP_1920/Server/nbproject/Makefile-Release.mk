...
${OBJECTDIR}/ServerThreadHandles.o: ServerThreadHandles.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServerThreadHandles.o ServerThreadHandles.c

${OBJECTDIR}/SigHandlers.o: SigHandlers.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SigHandlers.o SigHandlers.c
...
${OBJECTDIR}/serverFunctions.o: serverFunctions.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/serverFunctions.o serverFunctions.c
